            ...
            <Modal isModalOpen={isModalOpen} handleCloseModal={handleCloseModal} level={level}>
                <div className="flex flex-col items-center p-12 font-['Nunito_Sans']">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <span><Rocket size={35} className="text-black" fill="orange" /></span>
                    </div>

                    <p className="text-2xl mb-6">You are now <strong className="text-[#1F5D3D]">level {level}!</strong></p>
                    {/* rewards container */}
                    <div className="flex flex-col justify-center bg-[#1F5D3D]/30 shadow-lg rounded-xl p-10 w-full max-w-md">
                        ...
                        <div className="flex items-start gap-2 mt-6 text-xl">
                            ...
                            <p className="mb-6">
                                New Title: <strong className="text-[#1F5D3D] font-['Lora']">"{reward.title}"</strong>
                            </p>
                        </div>
                        <div className="flex items-start gap-2 text-xl">
                            <Trophy size={20} className="text-yellow-700 mt-1" />
                            <p>New Icon:</p>
                            <span><reward.icon size={25} style={{ color: reward.iconColor }} /></span>
                            <span className="font-bold text-[#1F5D3D] font-['Lora']">
                ...
                <div>
                    <button onClick={handleCloseModal} className="border-2 border-black rounded-xl px-4 py-2 bg-amber-700 hover:bg-amber-800 text-white mt-4 hover:cursor-pointer font-['Nunito_Sans'] transition">
                        Close
                    </button>
                </div>
            </Modal>
