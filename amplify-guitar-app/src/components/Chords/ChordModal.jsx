  ...
  return (
    <div className="font-['Nunito_Sans'] text-lg">
      ...
      <img
        ...
        className="mt-6 mb-6 w-full max-w-[95%] mx-auto h-auto rounded-xl shadow-lg"
      />

      <div className="border-t-2 border-b-2 border-[#D4A574]">
        <Disclosure
          as="div"
          className="p-6 w-full max-w-[95%] mx-auto border-3 border-black rounded-xl mt-4 mb-4 shadow-lg hover:shadow-xl bg-[#1F5D3D] dark:border-[#D4A574] dark:bg-slate-700 dark:hover:bg-slate-800 hover:bg-[#1F5D3D]/95 text-white"
        >
      ...
      {selectedItem.fingerPositions && (
        <div>
          <p className="font-semibold text-center text-xl mb-4 mt-4 w-full">
            Finger Positions (top to bottom):
          </p>
          <ul>
