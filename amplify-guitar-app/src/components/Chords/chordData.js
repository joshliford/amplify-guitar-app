...
export const chords = [
  {
    ...
    details:
      "G Major primarily uses 3 fingers across the lowE, A, and highE strings.",
    tips: [
  ...
  },
  {
    ...
    details:
      "Triangle shape on the G, B, and highE strings with an open D string.",
    tips: [
  ...
  },
  {
    ...
    details:
      "Three fingers packed tightly on the 2nd fret. Can also be played with one finger by 'barring' the D, G, and B strings while leaving the A string open to ring.",
    tips: [
  ...
  },
  {
    ...
    details:
      "Two fingers on the A and D strings while playing all 6 strings with one smooth strum.",
    tips: [
  ...
  },
  {
    ...
    description:
      "A fairly challenging barre chord with bright and punchy tones",
