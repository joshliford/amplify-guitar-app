...
export const scales =
    [
        {   id: 1,
            ...
            description: "One of the most common scales that can be used for many genres and styles.",
            details: "Expressive minor sound that fits blues, rock, and modern soloing effortlessly.",
            image: aMinPent,
            tab: aMinPentTab,
            position: [
                "Position: 5th fret (Box 1)",
                "Root notes on 5th and 7th frets"
            ],
            whenToUse: [
        ...
        {   id: 2,
            ...
            tab: gPentMajTab,
            position: [
                "Position: 3rd fret (Box 1)",
                "Root notes on 3rd and 5th frets"
            ],
            whenToUse: [
        ...
        {   id: 3,
            ...
            details: "Gritty, expressive minor sound that fuels blue, rock, and classic guitar solos.",
            image: eMinPent,
            tab: eMinPentTab,
            position: [
        ...
        {   id: 4,
            category: "scale",
            title: "A Blues Scale", 
            description: "6-note scale that is similar to A Minor Pentatnoic, just with an additional note.",
        ...
        {   id: 5,
            ...
            details: "Dark, minor sound that creates expressive melodies in rock & metal.",
            image: eAeolian,
            tab: eAeolianTab,
            position: [
        ...
        {   id: 6,
            ...
            description: "Smooth, groovy, 'cool jazz' character ideal for funk, fusion, and modal improvisation.",
            details: "Smooth, cool minor sound with subtle brightness thanks to the raised sixth.",
            image: eDorian,
            tab: eDorianTab,
            position: [
