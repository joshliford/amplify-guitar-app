    ...
    return (
        ...
        <Card title={scale.title} description={scale.description} category={scale.category}>
            <div className="flex justify-center">
                ...
                */}
                <button className="mt-2 p-2 bg-amber-700 hover:bg-amber-800 rounded-xl shadow-lg text-white hover:cursor-pointer hover:shadow-xl" onClick={() => handleViewItem(scale)}>
                    View Scale
                </button>
            </div>
        </Card>
